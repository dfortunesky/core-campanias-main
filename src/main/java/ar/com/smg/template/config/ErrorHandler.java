...
import ar.com.smg.template.domain.exception.ValidationException;
import ar.com.smg.template.domain.helper.SybaseHelper;
...
public class ErrorHandler {
    ...
    public ResponseEntity<ErrorResponse> handle(final SybSQLException ex) {
        if (SybaseHelper.isRaiseError(ex)) {
    ...
    private ResponseEntity<ErrorResponse> buildResponseError(
        ...
        log.error(String.format("Error en core-template | %s: %s", ex.getClass().getCanonicalName(), ex.getMessage()));
